...
const BuildYourPair = () => {
  return (
    <section
      className="relative md:py-16 py-10 md:px-12 px-4 bg-no-repeat bg-cover md:bg-center bg-position-[90%_50%]"
      style={{ backgroundImage: "url('/footer-top.png')" }}
    >
      <div className="container mx-auto flex justify-start items-center">
        <div className="md:w-1/3 w-full md:pt-32 pt-6">
          <h2 className="md:text-9xl text-5xl uppercase font-extrabold text-black">
            Build Your Pair
          </h2>
